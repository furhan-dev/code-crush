            ...
            <main className="flex-row justify-center mb-4">
              ...
              <p>
                ...
                <Link to="/">back to the homepage.</Link>
                                    ...
                                    <input id="email" name='email' value={formState.email} onChange={handleChange} type="email" size="64" maxLength="64" required placeholder="Example@gmail.com" pattern=".+@gmail.com" title="Example@gmail.com"/>
                                    </div>
